...
<head>
    ...
    <!-- Custom CSS -->
    <link href="<?php echo asset_url() ?>css/blogas.css" rel="stylesheet">
    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand page-scroll" href="#page-top">
                <i class="fa fa-forumbee"></i>  <span class="light">Blogas</span>
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
            <ul class="nav navbar-nav">
                ...
                <li>
                    <a href="<?php echo base_url()?>#about">Apie idėją</a>
                </li>
                <li>
                    <a href="<?php echo base_url()?>#board">Reklama</a>
                </li>
                <li>
                    <a href="<?php echo base_url()?>#contact">Kontaktai</a>
                </li>
                <li>
                    <a href="<?php echo base_url()?>index.php/site/redaguoti_bloga">Redaguoti</a>
                </li>
                <li>
